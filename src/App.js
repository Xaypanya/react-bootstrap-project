    ...
    <div className="App">
      ...
      <div className='right_container'>
        ...
        <div className="test_report">
          <h2>Test Reports</h2>
          <div className='test_report_card_container'>
            {/* Test Result Card */}
          <div className='test_report_card'>
            <div>
        ...
        <div className="Prescription">
          ...
          <table>
            ...
            <tr>
              ...
              <td>
                <h3 className='fade'>25th October 2019</h3>
              </td>
              <td>
                <h3 className='fade'>3 months</h3>
              </td>
            </tr>
            <tr>
              <td>
              ...
              <td>
                <h3 className='fade'>8th August 2019</h3>
              </td>
              <td>
                <h3 className='fade'>2 months</h3>
              </td>
            </tr>
          </table>
        </div>
